...
3.  Ensure the `game_data_directory` path points to a folder which should contain a `master` directory and a `meta` file. The tool will attempt to auto-detect this.
